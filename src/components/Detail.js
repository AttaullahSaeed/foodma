...
import SubTotalforDetailPage from './SubTotalforDetailPage';
import DetailpageItems from './DetailpageItems';
...
{/* 
		               ...
		               <div className="bg-white rounded shadow-sm text-white mb-4 p-4 clearfix restaurant-detailed-earn-pts card-icon-overlap">
	                     ...
	                     <div className="mb-2 bg-white rounded p-2 clearfix">
	                        ...
	                        <h6 className="font-weight-bold text-right mb-2"> <span className="text-danger"><SubTotalforDetailPage/></span></h6>
